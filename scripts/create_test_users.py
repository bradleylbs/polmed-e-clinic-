...
TEST_USERS = [
    ...
    },
    {
        ...
        'email': 'dentist.test@polmed.co.za',
        'password': 'dentist123',
        'first_name': 'Dr. Alex',
        'last_name': 'Ngwenya',
        'role_name': 'dentist',
    ...
    {
        'username': 'optometrist_test',
        'email': 'optometrist.test@polmed.co.za',
        'password': 'optometrist123',
        'first_name': 'Dr. Lerato',
        'last_name': 'Mokoena',
    ...
    {
        'username': 'audiologist_test',
        'email': 'audiologist.test@polmed.co.za',
        'password': 'audiologist123',
        'first_name': 'Dr. Musa',
        'last_name': 'Nkosi',
        'role_name': 'audiologist',
    ...
    {
        'username': 'gynaecologist_test',
        'email': 'gynaecologist.test@polmed.co.za',
        'password': 'gyn123',
        'first_name': 'Dr. Zanele',
        'last_name': 'Khumalo',
        'role_name': 'gynaecologist',
        'phone_number': '+27123456798',
        'geographic_restrictions': '["KwaZulu-Natal"]',
        'mp_number': 'GYN567890',
        'is_active': True,
        'requires_approval': False
    ...
    {
        'username': 'ultrasound_test',
        'email': 'ultrasound.test@polmed.co.za',
        'password': 'ultrasound123',
        'first_name': 'Dr. Brian',
        'last_name': 'Petersen',
        'role_name': 'ultrasound',
        'phone_number': '+27123456799',
    ...
    {
        'username': 'psychologist_test',
        'email': 'psychologist.test@polmed.co.za',
        'password': 'psychology123',
        'first_name': 'Dr. Nomsa',
        'last_name': 'Dlamini',
        'role_name': 'psychologist',
        'phone_number': '+27123456800',
        'geographic_restrictions': '["Free State"]',
        'mp_number': 'PSY678901',
        'is_active': True,
        'requires_approval': False
    },
